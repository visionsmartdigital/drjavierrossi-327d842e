...
const services: Service[] = [
  ...
  },
  {
    ...
    textEs: "Intervenciones precisas sobre la estructura ósea del rostro para lograr proporciones armónicas y resultados estructurales duraderos.",
  ...
  },
  {
    ...
    textEs: "Abordaje integral del rejuvenecimiento con las técnicas más avanzadas. Resultados naturales que respetan la identidad del paciente.",
  ...
  },
  {
    ...
    textEs: "Recuperá una mirada fresca y descansada. Blefaroplastia y procedimientos de rejuvenecimiento periocular con resultados naturales.",
